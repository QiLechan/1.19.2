...
public class TrueTypeGlyphProvider implements GlyphProvider {
   ...
   public GlyphInfo getGlyph(int var1) {
      if (this.skip.contains(var1)) {
         ...
         IntBuffer var4;
         label61: {
            TrueTypeGlyphProvider.Glyph var16;
            label62: {
               ...
               try {
                  ...
                  if (var11 > 0 && var12 > 0) {
                     var16 = new TrueTypeGlyphProvider.Glyph(var4.get(0), var6.get(0), -var5.get(0), -var7.get(0), var10, (float)var9.get(0) * this.pointScale, var3);
                     break label62;
                  }
