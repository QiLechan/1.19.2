...
public class ChatLogSegmenter<T extends LoggedChatMessage> {
   ...
   public boolean accept(ChatLog.Entry<T> var1) {
      ChatLogSegmenter.MessageType var2 = (ChatLogSegmenter.MessageType)this.typeFunction.apply(var1);
   ...
   public static enum MessageType {
      ...
      // $FF: synthetic method
      private static ChatLogSegmenter.MessageType[] $values() {
         return new ChatLogSegmenter.MessageType[]{REPORTABLE, CONTEXT};
      }
   }
   ...
   public static record Results<T extends LoggedChatMessage>(List<ChatLog.Entry<T>> a, ChatLogSegmenter.MessageType b) {
      ...
      public ChatLogSegmenter.MessageType type() {
         return this.type;
      }
   }
}
