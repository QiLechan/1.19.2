...
public class ConnectScreen extends Screen {
   ...
   private void connect(final Minecraft var1, final ServerAddress var2) {
      final CompletableFuture var3 = var1.getProfileKeyPairManager().preparePublicKey();
      ...
      Thread var4 = new Thread("Server Connector #" + UNIQUE_THREAD_ID.incrementAndGet()) {
         public void run() {
            ...
            try {
               ...
               ConnectScreen.this.connection.send(new ServerboundHelloPacket(var1.getUser().getName(), (Optional)var3.join(), Optional.ofNullable(var1.getUser().getProfileId())));
               ...
               String var7 = var1x == null ? var3x.getMessage() : var3x.getMessage().replaceAll(var1x.getHostName() + ":" + var1x.getPort(), "").replaceAll(var1x.toString(), "");
               var1.execute(() -> {
