...
public class SystemToast implements Toast {
   ...
   public static enum SystemToastIds {
      ...
      private static SystemToast.SystemToastIds[] $values() {
         return new SystemToast.SystemToastIds[]{TUTORIAL_HINT, NARRATOR_TOGGLE, WORLD_BACKUP, WORLD_GEN_SETTINGS_TRANSFER, PACK_LOAD_FAILURE, WORLD_ACCESS_FAILURE, PACK_COPY_FAILURE, PERIODIC_NOTIFICATION, CHAT_PREVIEW_WARNING, UNSECURE_SERVER_WARNING};
      }
   }
}
