...
public abstract class AbstractScrollWidget extends AbstractWidget implements Widget, GuiEventListener {
   ...
   public void renderButton(PoseStack var1, int var2, int var3, float var4) {
      if (this.visible) {
         ...
         var1.pushPose();
         var1.translate(0.0D, -this.scrollAmount, 0.0D);
   ...
   private void renderScrollBar() {
      ...
      var7.vertex((double)var2, (double)var5, 0.0D).color(128, 128, 128, 255).endVertex();
      var7.vertex((double)var3, (double)var5, 0.0D).color(128, 128, 128, 255).endVertex();
      var7.vertex((double)var3, (double)var4, 0.0D).color(128, 128, 128, 255).endVertex();
      var7.vertex((double)var2, (double)var4, 0.0D).color(128, 128, 128, 255).endVertex();
      var7.vertex((double)var2, (double)(var5 - 1), 0.0D).color(192, 192, 192, 255).endVertex();
      var7.vertex((double)(var3 - 1), (double)(var5 - 1), 0.0D).color(192, 192, 192, 255).endVertex();
      var7.vertex((double)(var3 - 1), (double)var4, 0.0D).color(192, 192, 192, 255).endVertex();
      var7.vertex((double)var2, (double)var4, 0.0D).color(192, 192, 192, 255).endVertex();
      var6.end();
   }
