...
public class MultilineTextField {
   ...
   public MultilineTextField.StringView getLineView(int var1) {
      return (MultilineTextField.StringView)this.displayLines.get(Mth.clamp((int)var1, (int)0, (int)(this.displayLines.size() - 1)));
   }
   ...
   public void seekCursorToPoint(double var1, double var3) {
      ...
      MultilineTextField.StringView var7 = (MultilineTextField.StringView)this.displayLines.get(Mth.clamp((int)var6, (int)0, (int)(this.displayLines.size() - 1)));
   ...
   private MultilineTextField.StringView getCursorLineView(int var1) {
      ...
      if (var2 < 0) {
         ...
         return (MultilineTextField.StringView)this.displayLines.get(Mth.clamp((int)(var2 + var1), (int)0, (int)(this.displayLines.size() - 1)));
      }
   }
