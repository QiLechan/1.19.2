...
public class ServerData {
   ...
   public void copyFrom(ServerData var1) {
      ...
      this.lan = var1.lan;
      this.chatPreview = (ServerData.ChatPreview)Util.mapNullable(var1.chatPreview, ServerData.ChatPreview::copy);
   ...
   public static class ChatPreview {
      public static final Codec<ServerData.ChatPreview> CODEC = RecordCodecBuilder.create((var0) -> {
