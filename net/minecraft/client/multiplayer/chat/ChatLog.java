...
public interface ChatLog {
   ...
   private default ChatLog.Selection selectNone() {
   ...
   public static record Entry<T extends LoggedChatEvent>(int a, T b) {
      ...
      public <U extends LoggedChatEvent> ChatLog.Entry<U> tryCast(Class<U> var1) {
         return var1.isInstance(this.event) ? new ChatLog.Entry(this.id, (LoggedChatEvent)var1.cast(this.event)) : null;
      }
   ...
   public static class Selection {
      ...
      public Collection<GameProfile> reportableGameProfiles() {
         return this.events().map((var0) -> {
            if (var0 instanceof LoggedChatMessage.Player) {
               LoggedChatMessage.Player var1 = (LoggedChatMessage.Player)var0;
