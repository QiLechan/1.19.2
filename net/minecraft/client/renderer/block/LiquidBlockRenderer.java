   ...
   public void tesselate(BlockAndTintGetter var1, BlockPos var2, VertexConsumer var3, BlockState var4, FluidState var5) {
      ...
      if (var24 || var25 || var29 || var28 || var26 || var27) {
         ...
         if (var24 && !isFaceOccludedByNeighbor(var1, var2, Direction.UP, Math.min(Math.min(var36, var38), Math.min(var37, var35)), var14)) {
            ...
            var64 = var31 * var10;
            var65 = var31 * var11;
            this.vertex(var3, var73 + 0.0D, var74 + (double)var36, var44 + 0.0D, var63, var64, var65, var48, var52, var62);
            this.vertex(var3, var73 + 0.0D, var74 + (double)var38, var44 + 1.0D, var63, var64, var65, var49, var53, var62);
            this.vertex(var3, var73 + 1.0D, var74 + (double)var37, var44 + 1.0D, var63, var64, var65, var50, var54, var62);
            this.vertex(var3, var73 + 1.0D, var74 + (double)var35, var44 + 0.0D, var63, var64, var65, var51, var55, var62);
