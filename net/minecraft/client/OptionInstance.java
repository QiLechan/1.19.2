...
public final class OptionInstance<T> {
   ...
   public OptionInstance(String var1, OptionInstance.TooltipSupplierFactory<T> var2, OptionInstance.CaptionBasedToString<T> var3, OptionInstance.ValueSet<T> var4, T var5, Consumer<T> var6) {
      this(var1, var2, var3, var4, var4.codec(), var5, var6);
   }

   public OptionInstance(String var1, OptionInstance.TooltipSupplierFactory<T> var2, OptionInstance.CaptionBasedToString<T> var3, OptionInstance.ValueSet<T> var4, Codec<T> var5, T var6, Consumer<T> var7) {
      super();
   ...
   public AbstractWidget createButton(Options var1, int var2, int var3, int var4) {
      OptionInstance.TooltipSupplier var5 = (OptionInstance.TooltipSupplier)this.tooltip.apply(Minecraft.getInstance());
   ...
   private static final class OptionInstanceSliderButton<N> extends AbstractOptionSliderButton implements TooltipAccessor {
      ...
      OptionInstanceSliderButton(Options var1, int var2, int var3, int var4, int var5, OptionInstance<N> var6, OptionInstance.SliderableValueSet<N> var7, OptionInstance.TooltipSupplier<N> var8) {
   ...
   interface SliderableValueSet<T> extends OptionInstance.ValueSet<T> {
      ...
      default Function<OptionInstance<T>, AbstractWidget> createButton(OptionInstance.TooltipSupplier<T> var1, Options var2, int var3, int var4, int var5) {
         return (var6) -> {
            return new OptionInstance.OptionInstanceSliderButton(var2, var3, var4, var5, 20, var6, this, var1);
         };
      }
   }
}
