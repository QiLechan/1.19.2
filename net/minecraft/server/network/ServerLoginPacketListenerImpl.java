...
public class ServerLoginPacketListenerImpl implements TickablePacketListener, ServerLoginPacketListener {
   ...
   @Nullable
   private static ProfilePublicKey validatePublicKey(@Nullable ProfilePublicKey.Data var0, UUID var1, SignatureValidator var2, boolean var3) throws ProfilePublicKey.ValidationException {
      if (var0 == null) {
         if (var3) {
         ...
         return ProfilePublicKey.createValidated(var2, var1, var0, Duration.ZERO);
      }
   }
   ...
   public void handleKey(ServerboundKeyPacket var1) {
      ...
      try {
         ...
         if (this.profilePublicKeyData != null) {
            ProfilePublicKey var4 = new ProfilePublicKey(this.profilePublicKeyData);
