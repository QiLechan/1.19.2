   ...
   public static final class InMemoryStorage implements RegistryResourceAccess {
      ...
      public <E> Map<ResourceKey<E>, RegistryResourceAccess.EntryThunk<E>> listResources(ResourceKey<? extends Registry<E>> var1) {
         return (Map)this.entries.entrySet().stream().filter((var1x) -> {
            ...
            RegistryResourceAccess.InMemoryStorage.Entry var10000 = (RegistryResourceAccess.InMemoryStorage.Entry)var0.getValue();
      ...
      public <E> Optional<RegistryResourceAccess.EntryThunk<E>> getResource(ResourceKey<E> var1) {
         RegistryResourceAccess.InMemoryStorage.Entry var2 = (RegistryResourceAccess.InMemoryStorage.Entry)this.entries.get(var1);
         if (var2 == null) {
