      ...
      if (this.isNearPlayer(var1, var2)) {
         ...
         if (this.spawnDelay > 0) {
            ...
            for(int var4 = 0; var4 < this.spawnCount; ++var4) {
               ...
               double var10 = var8 >= 1 ? var7.getDouble(0) : (double)var2.getX() + (var9.nextDouble() - var9.nextDouble()) * (double)this.spawnRange + 0.5D;
               double var12 = var8 >= 2 ? var7.getDouble(1) : (double)(var2.getY() + var9.nextInt(3) - 1);
               double var14 = var8 >= 3 ? var7.getDouble(2) : (double)var2.getZ() + (var9.nextDouble() - var9.nextDouble()) * (double)this.spawnRange + 0.5D;
