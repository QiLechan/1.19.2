...
public class GossipContainer {
   ...
   static class GossipEntry {
      ...
      public static DataResult<GossipContainer.GossipEntry> load(Dynamic<?> var0) {
         return DataResult.unbox(DataResult.instance().group(var0.get("Target").read(UUIDUtil.CODEC), var0.get("Type").asString().map(GossipType::byId), var0.get("Value").asNumber().map(Number::intValue)).apply(DataResult.instance(), GossipContainer.GossipEntry::new));
      }
   }
}
