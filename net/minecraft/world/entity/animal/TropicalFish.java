...
public class TropicalFish extends AbstractSchoolingFish {
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor var1, DifficultyInstance var2, MobSpawnType var3, @Nullable SpawnGroupData var4, @Nullable CompoundTag var5) {
      ...
      if (var3 == MobSpawnType.BUCKET && var5 != null && var5.contains("BucketVariantTag", 3)) {
         ...
         int var8;
         int var9;
         if (var12 instanceof TropicalFish.TropicalFishGroupData) {
            TropicalFish.TropicalFishGroupData var11 = (TropicalFish.TropicalFishGroupData)var12;
            var6 = var11.base;
            var7 = var11.pattern;
            var8 = var11.baseColor;
            var9 = var11.patternColor;
         } else if ((double)var10.nextFloat() < 0.9D) {
            int var13 = Util.getRandom(COMMON_VARIANTS, var10);
            var6 = var13 & 255;
            var7 = (var13 & '\uff00') >> 8;
            var8 = (var13 & 16711680) >> 16;
            var9 = (var13 & -16777216) >> 24;
            var12 = new TropicalFish.TropicalFishGroupData(this, var6, var7, var8, var9);
         } else {
            this.isSchool = false;
