...
public interface SignedMessageValidator {
   static SignedMessageValidator create(@Nullable ProfilePublicKey var0, boolean var1) {
      return (SignedMessageValidator)(var0 != null ? new SignedMessageValidator.KeyBased(var0.createSignatureValidator()) : new SignedMessageValidator.Unsigned(var1));
   }
   ...
   public static enum State {
      ...
      // $FF: synthetic method
      private static SignedMessageValidator.State[] $values() {
         return new SignedMessageValidator.State[]{SECURE, NOT_SECURE, BROKEN_CHAIN};
      }
   }
}
