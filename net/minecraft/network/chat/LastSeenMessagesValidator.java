...
public class LastSeenMessagesValidator {
   ...
   public static enum ErrorCondition {
      ...
      // $FF: synthetic method
      private static LastSeenMessagesValidator.ErrorCondition[] $values() {
         return new LastSeenMessagesValidator.ErrorCondition[]{OUT_OF_ORDER, DUPLICATED_PROFILES, UNKNOWN_MESSAGES, REMOVED_MESSAGES};
      }
   }
}
