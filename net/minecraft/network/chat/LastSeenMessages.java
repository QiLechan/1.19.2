...
public record LastSeenMessages(List<LastSeenMessages.Entry> c) {
   ...
   public LastSeenMessages(FriendlyByteBuf var1) {
      this((List)var1.readCollection(FriendlyByteBuf.limitValue(ArrayList::new, 5), LastSeenMessages.Entry::new));
   }
   ...
   public void updateHash(DataOutput var1) throws IOException {
      ...
      while(var2.hasNext()) {
         LastSeenMessages.Entry var3 = (LastSeenMessages.Entry)var2.next();
   ...
   public List<LastSeenMessages.Entry> entries() {
      return this.entries;
   }
   ...
   public static record Update(LastSeenMessages a, Optional<LastSeenMessages.Entry> b) {
      ...
      public Optional<LastSeenMessages.Entry> lastReceived() {
