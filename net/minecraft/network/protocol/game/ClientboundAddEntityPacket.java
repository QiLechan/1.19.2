...
public class ClientboundAddEntityPacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundAddEntityPacket(Entity var1, int var2) {
      this(var1.getId(), var1.getUUID(), var1.getX(), var1.getY(), var1.getZ(), var1.getXRot(), var1.getYRot(), var1.getType(), var2, var1.getDeltaMovement(), 0.0D);
   }

   public ClientboundAddEntityPacket(Entity var1, int var2, BlockPos var3) {
      this(var1.getId(), var1.getUUID(), (double)var3.getX(), (double)var3.getY(), (double)var3.getZ(), var1.getXRot(), var1.getYRot(), var1.getType(), var2, var1.getDeltaMovement(), 0.0D);
   }
