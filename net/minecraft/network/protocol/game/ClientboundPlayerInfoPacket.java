...
public class ClientboundPlayerInfoPacket implements Packet<ClientGamePacketListener> {
   ...
   private static ClientboundPlayerInfoPacket.PlayerUpdate createPlayerUpdate(ServerPlayer var0) {
      ...
      return new ClientboundPlayerInfoPacket.PlayerUpdate(var0.getGameProfile(), var0.latency, var0.gameMode.getGameModeForPlayer(), var0.getTabListDisplayName(), var2);
   }
   ...
   public static enum Action {
      ...
      UPDATE_GAME_MODE {
         protected ClientboundPlayerInfoPacket.PlayerUpdate read(FriendlyByteBuf var1) {
            ...
            GameType var3 = GameType.byId(var1.readVarInt());
            return new ClientboundPlayerInfoPacket.PlayerUpdate(var2, 0, var3, (Component)null, (ProfilePublicKey.Data)null);
         }
      ...
      UPDATE_LATENCY {
         protected ClientboundPlayerInfoPacket.PlayerUpdate read(FriendlyByteBuf var1) {
            ...
            return new ClientboundPlayerInfoPacket.PlayerUpdate(var2, var3, (GameType)null, (Component)null, (ProfilePublicKey.Data)null);
         }
      ...
      UPDATE_DISPLAY_NAME {
         protected ClientboundPlayerInfoPacket.PlayerUpdate read(FriendlyByteBuf var1) {
            ...
            return new ClientboundPlayerInfoPacket.PlayerUpdate(var2, 0, (GameType)null, var3, (ProfilePublicKey.Data)null);
         }
      ...
      REMOVE_PLAYER {
         protected ClientboundPlayerInfoPacket.PlayerUpdate read(FriendlyByteBuf var1) {
            GameProfile var2 = new GameProfile(var1.readUUID(), (String)null);
            return new ClientboundPlayerInfoPacket.PlayerUpdate(var2, 0, (GameType)null, (Component)null, (ProfilePublicKey.Data)null);
         }
